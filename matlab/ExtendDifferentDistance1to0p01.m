...
filename=('/Volumes/eng_rsch_nablab01$/Mahshid/Flourescence results /encapsulated R6G and RB/SiR6G-SiRB-used in matlab.xlsx');
...
Fl_Table = table(x);
N_R6G=1341;% The Number of R6g molecules
N_RB=86;% The Number of RB molecules
% if N_R6G+N_RB >N^2 print "Unphysical situation" and stop
...
% figure
% plot(x, Fl)
writetable(Fl_Table,'dataTableFl0p01August12.csv')
%hold on
